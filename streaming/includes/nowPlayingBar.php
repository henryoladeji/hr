...
function setTrack(trackId, newPlaylist, play) {
	...
	$.post("includes/handlers/ajax/getSongJson", { songId: trackId }, function(data) {

		var track = JSON.parse(data);

		$(".trackName span").text(track.title);

		$.post("includes/handlers/ajax/getArtistJson", { artistId: track.artist }, function(data) {
			var artist = JSON.parse(data);

			$(".artistName span").text(artist.name);
			$(".artistName span").attr("onclick", "openPage('artist.php?id=" + artist.id + "')");

			// $.post("includes/handlers/ajax/getFeatureJson", {featureId: track.feature}, function(data){
			// 	var feature = JSON.parse(data);

			// 	$(".featureArtist span").text(feature.name);	
