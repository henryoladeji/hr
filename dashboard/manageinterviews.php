...
$sql = "UPDATE interview SET applicant_email = '$applicant_email', vacancy_name = '$vacancy_name', location = '$location', score = '$score', interview_date = '$interview_date' WHERE applicant_email='$applicant_email' ";
        ...
        <div class="col-md-12 agile-calendar" >
            <div class="calendar-widget" style="background:rgba(52, 48, 48, 0.78);">
                <div class="panel-heading ui-sortable-handle">
                    ...
                    <span class="panel-title">Manage Interview</span>
                </div>
                <!-- grids -->
                    <div class="agile-calendar-grid">
                       
                     
        <form action="manageinterviews.php" method="post">
            <br>
            ...
            <br>
            <label for="sel1" style="color:white;">Select Interview Date:</label>
             ...
             <br><br>
             <label for="sel1" style="color:white;">Enter Score:</label>
             <input type="text" class="ggg" name="score" placeholder="Enter Score" required>
             <br><br>
