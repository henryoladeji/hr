...
$row_opening_count = mysqli_fetch_assoc($opening_count);
        ...
        <div class="col-md-12 agile-calendar" >
            <div class="calendar-widget" >
                <div class="panel-heading ui-sortable-handle">
                    ...
                    <span>Open Vacancies - <?php echo "(".$row_opening_count['COUNT(*)'].")";?></span>
                </div>
...
<table>
  ...
  <tr>
    ...
    <td><?php echo $row_opening_date['date_opening']; ?></td>
  </tr>
