...
mysqli_select_db($DB_con,"hrdb");
$query_interview = "SELECT * FROM interview";
$interview = mysqli_query($DB_con, $query_interview) or die(mysql_error());
$row_interview = mysqli_fetch_assoc($interview);
$totalRows_interview = mysqli_num_rows($interview);
...
<table>
  ...
  <tr>
    <?php $sn =1; do { ?>
    <td><?php echo $sn++; ?></td>
    <td><?php echo $row_interview['applicant_email']; ?></td>
    <td><?php echo $row_interview['vacancy_name']; ?></td>
    <td><?php echo $row_interview['location']; ?></td>
    <td><?php echo $row_interview['score']; ?></td>
    <td><?php echo $row_interview['interview_date']; ?></td>
  </tr>

 <?php } while ($row_interview = mysqli_fetch_assoc($interview)); ?>
